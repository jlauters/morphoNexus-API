...
class NexusHandler():
  ...
  def condense_block(self):
    ...
    # Condense duplicate block generated by MrBayes but Mesquite throws an error 
    filedata = None
  ...
  def reset_dimensions(self, error_msg):
  ...
  def read_file(self):
    ...
    try:
      ...
      if str(e).strip() == "Duplicate Block mrbayes":
        ...
        # Condense duplicate block and try again 
        self.condense_block() 
        self.read_file()
    ...
    if self.nr is not None:
      ...
      if charstate is not None:
        ...
        # TODO: If available Charsstate labels block should have a continuous string with the following format
        #
        ...
        if self.character_descriptions:
          ...
          print "doing full charstate label section"
